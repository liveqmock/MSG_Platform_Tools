...
public class Element extends Node {
     ...
     * @see #textNodes()
     */
    public String text(final String...tags) {
        return text(null , tags) ;
    }
     ...
     * @see #textNodes()
     */
    public String text(String host , final String...tags) {
            ...
            public void head(Node node, int depth) {
                if (node instanceof TextNode) {
                    ...
                    if(tags!=null && tags.length>0){
	                    for(String tag : tags){
	                    	if(element.tag.getName().toLowerCase().equals(tag)){
	                    		accum.append(element.toString());
	                    	}
	                    }
                    }else{
                    	if (accum.length() > 0 &&
