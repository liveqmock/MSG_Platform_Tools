...
import com.neusoft.util.comet.core.util.ExplorerUtil;
import com.neusoft.util.comet.core.util.NetUtil;
...
public class CometConnection {
	...
	public CometConnection(HttpServletRequest anRequest, HttpServletResponse anResponse) {
		...
		if(user!=null && user.getAgentno()!=null){
			id = user.getAgentno().toString();
			orgi = user.getOrgi() ;
		}
	}
