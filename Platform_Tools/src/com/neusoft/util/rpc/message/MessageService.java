...
public class MessageService {
	...
	public static class sendMessage_args implements TBase, java.io.Serializable, Cloneable {
		...
		public static final Map<Integer, FieldMetaData> metaDataMap = Collections.unmodifiableMap(new HashMap<Integer, FieldMetaData>() {
			{
				put(MSG, new FieldMetaData("msg", TFieldRequirementType.DEFAULT, new StructMetaData(TType.STRUCT, Message.class)));
			}
		});
		...
		public sendMessage_args(Message msg) {
			this();
			this.msg = msg;
		}
		...
		// Returns true if field msg is set (has been asigned a value) and false
		// otherwise
