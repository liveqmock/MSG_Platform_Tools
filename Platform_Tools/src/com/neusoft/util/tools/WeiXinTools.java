...
//    	String content = RivuTools.postFileData( "https://mp.weixin.qq.com/cgi-bin/uploadmaterial?cgi=uploadmaterial&type=0&token="+token+"&t=iframe-uploadfile&lang=zh_CN" ,"C:\\Users\\admin\\Desktop\\v4\\img\\glyphicons_halflings.png") ;
...
//    	List<WeiXinGroup> list=getWeixinGroupList("rivues");
    	...
    	System.out.println(RivuTools.postString("https://api.weixin.qq.com/cgi-bin/message/template/send?access_token="+token.getAccess_token(), menutext , "UTF-8") ) ;
    	*/
