...
import com.neusoft.core.datasource.EapDataSource;
...
//      System.err.println("setting driverClass: " + driverClass); 
    ...
    {  
    	EapDataSource eapDataSource = new EapDataSource();
    	eapDataSource.setUrl(dmds.getJdbcUrl()==null||dmds.getJdbcUrl().length()<2?null:dmds.getJdbcUrl()) ;
    	dmds.setJdbcUrl(eapDataSource.getUrl()) ;
        return eapDataSource.getUrl(); 
    }
